                                                 ...
                                                 const NodeVector& deltas)
{
    ...
    auto arg0 = inputs().at(0).get_source_output().get_node_shared_ptr(); // NxIxJ (maybe transposed)
    auto arg1 = inputs().at(1).get_source_output().get_node_shared_ptr(); // NxJxK (maybe transposed)
